...
#import "ParsingTableViewController.h"
#import "CustomParsingTableViewCell.h"
#import "Plant.h"

@interface ParsingTableViewController ()

@end

@implementation ParsingTableViewController
...
- (void)viewDidLoad {
  ...
  //  NSURL *url=[[NSBundle mainBundle]URLForResource:@"plant"with withExtension:@"xml"];
   ...
   // [self.tableView registerClass:[UITableViewCell class] forCellReuseIdentifier:@"cell"];
    ...
    [self.tableView registerNib:[UINib nibWithNibName:@"CustomParsingTableViewCell" bundle:nil] forCellReuseIdentifier:@"cell"];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    CustomParsingTableViewCell *cell=[tableView dequeueReusableCellWithIdentifier:@"cell"forIndexPath:indexPath];
